...
if (empty($dataInicial) && empty($dataFinal)) {
    ...
    $equipamento=$converte;
    $query = "SELECT * FROM historicoleituras WHERE MINUTE (Data_Da_Leitura) % '$intervalo' = 0 AND id_Equipamento = $equipamento
    ...
    $query = "SELECT * FROM historicoleituras WHERE MINUTE(Data_Da_Leitura) % '$intervalo' = 0 AND data BETWEEN '$startDate' AND '$endDate' 
    AND id_Equipamento = $equipamento order by id desc";
}
